...
public:
    ...
    */
    bool moveEclaireur(Position & p, Position & toGo, Position dir, int distance);
    /**
    ...
    */
    std::optional<GameElement> move(Position p, DIRECTION dir, int distance = 1);
    /**
    ...
    */
    GameElement & getSoldier(const Position & pos); // je pense qu'ici on va devoir choisir entre celui la
    /**
